...
if __name__ == '__main__':
    ...
    startTime = '2025-06-17T23:00:00Z'
    ...
    model = ml.modelLSTM("lstm_relative_3y_01_06_2025")
    forecasted = model.forecast(data, 'price')

    cumulus = initdata
    for i in range(len(forecasted)):
        cumulus += forecasted.iloc[i]
        forecasted.iloc[i] = cumulus
